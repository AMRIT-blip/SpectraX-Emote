...
const LOGIN_STORAGE_KEY = "spectrax_login_unlocked";
...
function showSection(id) {
    ...
    document.querySelector('.profile-row').style.display = 'none';
...
function showHome() {
    ...
    document.getElementById('home-hero').style.display = 'grid';
    document.querySelector('.profile-row').style.display = 'block';
}
